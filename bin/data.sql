...
insert into users(username,password,person_id,enabled) values
	('batman','batman',1,true),
    ('superman','superman',2,true),
    ('catwoman','catwoman',3,true),
    ('daredevil','daredevil',4,true),
    ('alfred','alfred',5,true),
    ('dococ','dococ',6,true),
    ('zod','zod',7,true),
    ('spiderman','spiderman',8,true),
    ('ironman','ironman',9,true),
    ('profx','profx',10,true);
